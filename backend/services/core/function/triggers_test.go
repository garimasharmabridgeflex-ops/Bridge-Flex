...
const testDatabasePath = "projects/demo-bridgeflex/databases/(default)/documents"
...
func firestoreWriteEvent(t *testing.T, docPath string, fields map[string]*firestoredata.Value) event.Event {
	...
	e.SetSource("//firestore.googleapis.com/projects/demo-bridgeflex/databases/(default)")
